...
function Footer() {
  return (
    <footer>
      <p>
        © 2025 Board Games Shelf. Made with ❤️ |{" "}
        <a
        ...
        >
          ...
          >
            <path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.302 
              3.438 9.8 8.207 11.387.599.111.793-.261.793-.577 
              0-.285-.01-1.04-.016-2.04-3.338.726-4.042-1.416-4.042-1.416 
              ...
              1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 
              1.102.823 2.222 0 1.604-.015 2.896-.015 3.293 
              0 .316.192.694.801.576C20.565 22.092 24 17.592 
